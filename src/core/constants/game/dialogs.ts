    ...
    screens: [
      ...
      },
      {
        ...
        answers: [
          ...
          {
            text: 'Да, молодые люди часто так говорят. И я говорила, потому что боялась и не знала, как одновременно реализовать свои желания и амбиции и воспитывать ребёнка. Оказалось, это возможно… Переживания вашего молодого человека понятны. За что переживаете вы?',
            goTo: '3_0',
          },
        ],
      },
      {
        ...
        answers: [
          ...
          {
            text: 'Мария Сергеевна, спасибо, что вы пришли на приём и открыто говорите о том, что вас беспокоит. Хочу сказать: «Я, как врач, всегда рядом и готова помочь». Скажите, пожалуйста… что или, может быть, кто ещё поддержит вас в решении сохранить беременность?',
            goTo: '1_2',
          },
          {
            text: 'Правильно я понимаю, что вы растеряны не потому, что беременны, а из-за того, что беременность наступила неожиданно?',
            goTo: '1_3',
          },
        ],
      },
      {
        ...
        answers: [
          {
            text: 'Мы можем пойти с вами путём, который предлагают ваши родители… Будем рожать?',
            goTo: '1_1_1',
          },
          {
            text: 'Очень важно, что родители поддерживают ваш выбор и готовы помогать с ребёнком. Я рада за вас.',
            goTo: '1_1_2',
          },
          {
            text: 'Иными словами, родители на вашей стороне и предлагают сохранить беременность? ',
            goTo: '1_1_3',
          },
        ],
      },
      ...
      },
      {
        ...
        answers: [
          {
            text: 'Да, я вас внимательно слушаю. Продолжайте.',
            goTo: '1_3_1',
          },
          {
            text: 'Очень хорошо, что вы задумывались о ребёнке. Значит, вы готовы стать мамой.',
            goTo: '1_3_2',
          },
          {
            text: 'Знаете, ваши слова «Я думала о ребёнке» привели меня к мысли, что вы уже приняли решение. И это решение – сохранить беременность. Я права?',
            goTo: '1_3_3',
          },
        ],
      },
      ...
      },
      {
        ...
        answers: [
          {
            text: 'Конечно, вы переживаете за отношения с вашим мужчиной. Я уверена, что вам можно помочь. Я готова выписать направление на консультацию психолога. Согласны?',
            goTo: '3_1',
          },
          {
            text: 'Да, это непростая ситуация... Хочу заметить, что беременность и рождение ребёнка – закономерное развитие отношений двух любящих друг друга людей. Как думаете?',
            goTo: '3_2',
          },
          {
            text: 'Как протекает ваша беременность?',
            goTo: '3_3_final',
          },
        ],
      },
